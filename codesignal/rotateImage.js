...
// //check
console.log('test1', rotateImage(test1));
console.log('test2', rotateImage(test2));
console.log('test3', rotateImage(test3));
console.log('test4', rotateImage(test4));
